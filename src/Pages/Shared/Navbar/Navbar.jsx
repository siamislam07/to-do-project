...
const Navbar = () => {
    ...
    return (
        <div className="fixed navbar bg-base-100 z-10 shadow-sm max-w-[2520px] mx-auto xl:px-20 md:px-10 sm:px-2 px-4">
            {/* <Container> */}
            <div className="navbar-start ">
                ...
                <Link to='/' className="btn btn-ghost normal-case text-base md:text-xl lg:text-xl ">Let's save you work</Link>
            </div>
